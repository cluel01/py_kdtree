...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "py_kdtree.cython.float64.point_query",
        "sources": [
            "py_kdtree/cython/float64/point_query.pyx"
        ]
    },
    "module_name": "py_kdtree.cython.float64.point_query"
}
END: Cython Metadata */
...
#define __PYX_HAVE__py_kdtree__cython__float64__point_query
#define __PYX_HAVE_API__py_kdtree__cython__float64__point_query
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include <math.h>
...
struct __pyx_ctuple_long__ptr__and_double__ptr;
typedef struct __pyx_ctuple_long__ptr__and_double__ptr __pyx_ctuple_long__ptr__and_double__ptr;

/* "py_kdtree/cython/float64/point_query.pyx":36
...
/* Module declarations from 'py_kdtree.cython.float64.point_query' */
...
static void __pyx_f_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(__Pyx_memviewslice, int, __Pyx_memviewslice, int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static __pyx_ctuple_long__ptr__and_double__ptr __pyx_f_9py_kdtree_6cython_7float64_11point_query__recursive_search_point(int, __Pyx_memviewslice, int, int, __Pyx_memviewslice, int, int, long *, double *, __Pyx_memviewslice); /*proto*/
static double __pyx_f_9py_kdtree_6cython_7float64_11point_query_get_max(double *, int); /*proto*/
static int __pyx_f_9py_kdtree_6cython_7float64_11point_query_get_max_idx(double *, int); /*proto*/
...
#define __Pyx_MODULE_NAME "py_kdtree.cython.float64.point_query"
extern int __pyx_module_is_main_py_kdtree__cython__float64__point_query;
int __pyx_module_is_main_py_kdtree__cython__float64__point_query = 0;

/* Implementation of 'py_kdtree.cython.float64.point_query' */
...
static PyObject *__pyx_pf_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_point, int __pyx_v_k, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, __Pyx_memviewslice __pyx_v_mmap, __Pyx_memviewslice __pyx_v_indices_view, __Pyx_memviewslice __pyx_v_distances_view); /* proto */
...
/* "py_kdtree/cython/float64/point_query.pyx":12
...
static PyObject *__pyx_pw_9py_kdtree_6cython_7float64_11point_query_1recursive_search_point(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(__Pyx_memviewslice __pyx_v_point, int __pyx_v_k, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, __Pyx_memviewslice __pyx_v_mmap, __Pyx_memviewslice __pyx_v_indices_view, __Pyx_memviewslice __pyx_v_distances_view, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  long __pyx_v_depth;
  ...
  int __pyx_t_2;
  int __pyx_t_3;
  __pyx_ctuple_long__ptr__and_double__ptr __pyx_t_4;
  long *__pyx_t_5;
  double *__pyx_t_6;
  Py_ssize_t __pyx_t_7;
  __Pyx_RefNannySetupContext("recursive_search_point", 0);

  /* "py_kdtree/cython/float64/point_query.pyx":15
 *                     int n_nodes,const double[:,:,::1] mmap,long[::1] indices_view,double[::1] distances_view):
 *     cdef int i
 *     cdef long depth = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":16
 *     cdef int i
 *     cdef long depth = 0
 *     cdef long* indices = <long*> malloc(k * sizeof(long))             # <<<<<<<<<<<<<<
 *     cdef double* distances =   <double*> malloc(k * sizeof(double))
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":17
 *     cdef long depth = 0
 *     cdef long* indices = <long*> malloc(k * sizeof(long))
 *     cdef double* distances =   <double*> malloc(k * sizeof(double))             # <<<<<<<<<<<<<<
 * 
 *     try:
 */
  __pyx_v_distances = ((double *)malloc((__pyx_v_k * (sizeof(double)))));

  /* "py_kdtree/cython/float64/point_query.pyx":19
 *     cdef double* distances =   <double*> malloc(k * sizeof(double))
 * 
 *     try:             # <<<<<<<<<<<<<<
 ...
 */
  /*try:*/ {
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":21
 *     try:
 *         #initializes distances
 *         for i in range(k):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":22
 *         #initializes distances
 *         for i in range(k):
 *             distances[i] = INFINITY             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":24
 *             distances[i] = INFINITY
 * 
 *         indices,distances = _recursive_search_point(0,point,k,depth,tree,n_leaves,n_nodes,indices,distances,mmap)             # <<<<<<<<<<<<<<
 *         for i in range(k):
 ...
 */
    __pyx_t_4 = __pyx_f_9py_kdtree_6cython_7float64_11point_query__recursive_search_point(0, __pyx_v_point, __pyx_v_k, __pyx_v_depth, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_indices, __pyx_v_distances, __pyx_v_mmap);
    __pyx_t_5 = __pyx_t_4.f0;
    __pyx_t_6 = __pyx_t_4.f1;
    __pyx_v_indices = __pyx_t_5;
    __pyx_v_distances = __pyx_t_6;

    /* "py_kdtree/cython/float64/point_query.pyx":25
 * 
 *         indices,distances = _recursive_search_point(0,point,k,depth,tree,n_leaves,n_nodes,indices,distances,mmap)
 *         for i in range(k):             # <<<<<<<<<<<<<<
 *             indices_view[i] = indices[i]
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":26
 *         indices,distances = _recursive_search_point(0,point,k,depth,tree,n_leaves,n_nodes,indices,distances,mmap)
 *         for i in range(k):
 *             indices_view[i] = indices[i]             # <<<<<<<<<<<<<<
 *             distances_view[i] = distances[i]
 ...
 */
      ...
      *((long *) ( /* dim=0 */ ((char *) (((long *) __pyx_v_indices_view.data) + __pyx_t_7)) )) = (__pyx_v_indices[__pyx_v_i]);
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":27
 *         for i in range(k):
 *             indices_view[i] = indices[i]
 *             distances_view[i] = distances[i]             # <<<<<<<<<<<<<<
 *         return
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_distances_view.data) + __pyx_t_7)) )) = (__pyx_v_distances[__pyx_v_i]);
    }

    /* "py_kdtree/cython/float64/point_query.pyx":28
 *             indices_view[i] = indices[i]
 *             distances_view[i] = distances[i]
 *         return             # <<<<<<<<<<<<<<
 *     finally:
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":30
 *         return
 *     finally:
 *         free(indices)             # <<<<<<<<<<<<<<
 *         free(distances)
 ...
 */
  /*finally:*/ {
    __pyx_L3_return: {
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":31
 *     finally:
 *         free(indices)
 *         free(distances)             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_9py_kdtree_6cython_7float64_11point_query_1recursive_search_point(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9py_kdtree_6cython_7float64_11point_query_1recursive_search_point(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("recursive_search_point (wrapper)", 0);
  {
    ...
    __pyx_v_point = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_point.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_k = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_k == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L3_error)
    __pyx_v_tree = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_tree.memview)) __PYX_ERR(0, 12, __pyx_L3_error)
    ...
    __pyx_v_mmap = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double__const__(values[5], 0); if (unlikely(!__pyx_v_mmap.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    ...
    __pyx_v_distances_view = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_distances_view.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("py_kdtree.cython.float64.point_query.recursive_search_point", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(__pyx_self, __pyx_v_point, __pyx_v_k, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_mmap, __pyx_v_indices_view, __pyx_v_distances_view);
...
static PyObject *__pyx_pf_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_point, int __pyx_v_k, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, __Pyx_memviewslice __pyx_v_mmap, __Pyx_memviewslice __pyx_v_indices_view, __Pyx_memviewslice __pyx_v_distances_view) {
  ...
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_9py_kdtree_6cython_7float64_11point_query_recursive_search_point(__pyx_v_point, __pyx_v_k, __pyx_v_tree, __pyx_v_n_leaves, __pyx_v_n_nodes, __pyx_v_mmap, __pyx_v_indices_view, __pyx_v_distances_view, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
...
static __pyx_ctuple_long__ptr__and_double__ptr __pyx_f_9py_kdtree_6cython_7float64_11point_query__recursive_search_point(int __pyx_v_node_idx, __Pyx_memviewslice __pyx_v_point, int __pyx_v_k, int __pyx_v_depth, __Pyx_memviewslice __pyx_v_tree, int __pyx_v_n_leaves, int __pyx_v_n_nodes, long *__pyx_v_indices, double *__pyx_v_distances, __Pyx_memviewslice __pyx_v_mmap) {
  int __pyx_v_l_idx;
  int __pyx_v_r_idx;
  int __pyx_v_axis;
  int __pyx_v_first;
  ...
  double __pyx_v_max_dist_sub;
  double __pyx_v_dist;
  double __pyx_v_sub;
  double __pyx_v_power;
  __pyx_ctuple_long__ptr__and_double__ptr __pyx_r;
  long __pyx_t_1;
  long __pyx_t_2;
  int __pyx_t_3;
  int __pyx_t_4;
  ...
  __pyx_ctuple_long__ptr__and_double__ptr __pyx_t_15;
  long *__pyx_t_16;
  double *__pyx_t_17;

  /* "py_kdtree/cython/float64/point_query.pyx":39
 *                           long* indices, double* distances,const double[:,:,::1] mmap) nogil:
 *     cdef int l_idx, r_idx,axis,first,second, lf_idx,dist_idx, i,j
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":44
 * 
 *     ############################## Leaf ##########################################################################
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":46
 *     if (l_idx >= tree.shape[0]) and (r_idx >= tree.shape[0]):
 *         #calculate distance for each contained point and check whether it is smaller than the ones found so far
 *         lf_idx = n_leaves+node_idx-n_nodes             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":47
 *         #calculate distance for each contained point and check whether it is smaller than the ones found so far
 *         lf_idx = n_leaves+node_idx-n_nodes
 *         for j in range(mmap.shape[1]):             # <<<<<<<<<<<<<<
 *             if j == mmap.shape[1]-1:
 ...
 */
    ...
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":48
 *         lf_idx = n_leaves+node_idx-n_nodes
 *         for j in range(mmap.shape[1]):
 *             if j == mmap.shape[1]-1:             # <<<<<<<<<<<<<<
 *                 if mmap[lf_idx,j,0] == -1.:
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_kdtree/cython/float64/point_query.pyx":49
 *         for j in range(mmap.shape[1]):
 *             if j == mmap.shape[1]-1:
 *                 if mmap[lf_idx,j,0] == -1.:             # <<<<<<<<<<<<<<
 *                     continue
 ...
 */
        ...
        if (__pyx_t_3) {
          ...
          /* "py_kdtree/cython/float64/point_query.pyx":50
 *             if j == mmap.shape[1]-1:
 *                 if mmap[lf_idx,j,0] == -1.:
 *                     continue             # <<<<<<<<<<<<<<
 *             dist = 0
 ...
 */
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":51
 *                 if mmap[lf_idx,j,0] == -1.:
 *                     continue
 *             dist = 0             # <<<<<<<<<<<<<<
 *             for i in range(tree.shape[1]): #dimensionality
 ...
 */
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":52
 *                     continue
 *             dist = 0
 *             for i in range(tree.shape[1]): #dimensionality             # <<<<<<<<<<<<<<
 *                 sub = mmap[lf_idx,j,i+1] - point[i]
 ...
 */
      ...
      for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
        ...
        /* "py_kdtree/cython/float64/point_query.pyx":53
 *             dist = 0
 *             for i in range(tree.shape[1]): #dimensionality
 *                 sub = mmap[lf_idx,j,i+1] - point[i]             # <<<<<<<<<<<<<<
 *                 power = sub*sub
 ...
 */
        ...
        __pyx_v_sub = ((*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_10 * __pyx_v_mmap.strides[0]) ) + __pyx_t_9 * __pyx_v_mmap.strides[1]) )) + __pyx_t_8)) ))) - (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_point.data) + __pyx_t_14)) ))));

        /* "py_kdtree/cython/float64/point_query.pyx":54
 *             for i in range(tree.shape[1]): #dimensionality
 *                 sub = mmap[lf_idx,j,i+1] - point[i]
 *                 power = sub*sub             # <<<<<<<<<<<<<<
 *                 dist = dist + power
 ...
 */
        ...
        /* "py_kdtree/cython/float64/point_query.pyx":55
 *                 sub = mmap[lf_idx,j,i+1] - point[i]
 *                 power = sub*sub
 *                 dist = dist + power             # <<<<<<<<<<<<<<
 *             dist = sqrt(dist)
 ...
 */
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":56
 *                 power = sub*sub
 *                 dist = dist + power
 *             dist = sqrt(dist)             # <<<<<<<<<<<<<<
 *             max_dist = get_max(distances,k)
 ...
 */
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":57
 *                 dist = dist + power
 *             dist = sqrt(dist)
 *             max_dist = get_max(distances,k)             # <<<<<<<<<<<<<<
 *             if dist < max_dist:
 ...
 */
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":58
 *             dist = sqrt(dist)
 *             max_dist = get_max(distances,k)
 *             if dist < max_dist:             # <<<<<<<<<<<<<<
 *                 dist_idx = get_max_idx(distances,k)
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "py_kdtree/cython/float64/point_query.pyx":59
 *             max_dist = get_max(distances,k)
 *             if dist < max_dist:
 *                 dist_idx = get_max_idx(distances,k)             # <<<<<<<<<<<<<<
 *                 distances[dist_idx] = dist
 ...
 */
        __pyx_v_dist_idx = __pyx_f_9py_kdtree_6cython_7float64_11point_query_get_max_idx(__pyx_v_distances, __pyx_v_k);

        /* "py_kdtree/cython/float64/point_query.pyx":60
 *             if dist < max_dist:
 *                 dist_idx = get_max_idx(distances,k)
 *                 distances[dist_idx] = dist             # <<<<<<<<<<<<<<
 *                 indices[dist_idx] = int(mmap[lf_idx,j,0])
 ...
 */
        ...
        /* "py_kdtree/cython/float64/point_query.pyx":61
 *                 dist_idx = get_max_idx(distances,k)
 *                 distances[dist_idx] = dist
 *                 indices[dist_idx] = int(mmap[lf_idx,j,0])             # <<<<<<<<<<<<<<
 *         return indices,distances
 ...
 */
        ...
        __pyx_t_8 = __pyx_v_j;
        __pyx_t_9 = 0;
        (__pyx_v_indices[__pyx_v_dist_idx]) = ((long)(*((double const  *) ( /* dim=2 */ ((char *) (((double const  *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_mmap.data + __pyx_t_14 * __pyx_v_mmap.strides[0]) ) + __pyx_t_8 * __pyx_v_mmap.strides[1]) )) + __pyx_t_9)) ))));
 ...
 */
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":62
 *                 distances[dist_idx] = dist
 *                 indices[dist_idx] = int(mmap[lf_idx,j,0])
 *         return indices,distances             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":64
 *         return indices,distances
 *     else:
 *         axis = depth % tree.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_3 = (((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_point.data) + __pyx_t_14)) ))) < __pyx_v_median) != 0);
    if (__pyx_t_3) {
 ...
 */
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":69
 *         if point[axis] < median:
 *             first = l_idx
 *             second = r_idx             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":71
 *             second = r_idx
 *         else:
 *             first = r_idx             # <<<<<<<<<<<<<<
 *             second = l_idx
 ...
 */
    /*else*/ {
      ...
      /* "py_kdtree/cython/float64/point_query.pyx":72
 *         else:
 *             first = r_idx
 *             second = l_idx             # <<<<<<<<<<<<<<
 *         indices,distances = _recursive_search_point(first,point,k,depth+1,tree,n_leaves,n_nodes,indices,distances,mmap)
 ...
 */
    ...
    /* "py_kdtree/cython/float64/point_query.pyx":73
 *             first = r_idx
 *             second = l_idx
 *         indices,distances = _recursive_search_point(first,point,k,depth+1,tree,n_leaves,n_nodes,indices,distances,mmap)             # <<<<<<<<<<<<<<
 *         max_dist = get_max(distances,k)
...
static double __pyx_f_9py_kdtree_6cython_7float64_11point_query_get_max(double *__pyx_v_array, int __pyx_v_size) {
  int __pyx_v_i;
  double __pyx_v_MAX;
  double __pyx_r;
  int __pyx_t_1;
...
static int __pyx_f_9py_kdtree_6cython_7float64_11point_query_get_max_idx(double *__pyx_v_array, int __pyx_v_size) {
  int __pyx_v_i;
  double __pyx_v_MAX;
  int __pyx_v_idx;
  int __pyx_r;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "py_kdtree.cython.float64.point_query.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "py_kdtree.cython.float64.point_query.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "py_kdtree.cython.float64.point_query.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "py_kdtree.cython.float64.point_query._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"recursive_search_point", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9py_kdtree_6cython_7float64_11point_query_1recursive_search_point, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_py_kdtree__cython__float64__point_query) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "py_kdtree.cython.float64.point_query")) {
      if (unlikely(PyDict_SetItemString(modules, "py_kdtree.cython.float64.point_query", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "py_kdtree/cython/float64/point_query.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init py_kdtree.cython.float64.point_query", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init py_kdtree.cython.float64.point_query");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
